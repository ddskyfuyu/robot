...
class TrainOutputTuple(collections.namedtuple("TrainOutputTuple", 
                                              ("train_summary", "train_loss", "predict_count","global_step", 
                                               "word_count", "batch_size", "grad_norm", "learning_rate"))):
    """
    @brief: 便于返回多种类型输出
    """
    pass
...
class BaseModel(object):
    ...
    def _set_params_initializer(self,
        ...
        initializer = model_helper.get_initializer(hparams.init_op, self.random_seed, hparams.init_weight)
    ...
    def _get_learning_rate_decay(self, hparams):
        ...
        return tf.cond(
            ...
            lambda: self.learning_rate,
            lambda: tf.train.exponential_decay(self.learning_rate, (self.global_step - start_decay_step),
    ...
    def build_graph(self, hparams, scope=None):
        ...
        ## Decoder
        logits, decoder_cell_outputs, sample_id, final_context_state = (self._build_decoder(self.encoder_outputs, 
    ...
    def _build_decoder_cell(self, hparams, encoder_outputs, encoder_state, source_sequence_length):
        ...
        Returns:
            A tuple of a multi-layer RNN cell used by decoder and the intial state of the decoder RNN.
        """
        pass
    ...
    def _softmax_cross_entropy_loss(self, logits, decoder_cell_outputs, labels):
        ...
        if self.num_sampled_softmax > 0:
            ...
            crossent = tf.nn.sampled_softmax_loss(weights=tf.transpose(self.output_layer.kernel),
...
class Model(BaseModel):
    ...
    def _build_encoder_from_sequence(self, hparams, sequence, sequence_length):
        ...
        with tf.variable_scope("encoder") as scope:
            ...
            if hparams.encoder_type == "uni":
                ...
                encoder_outputs, bi_encoder_state = (self._build_bidirectional_rnn(inputs=self.encoder_emb_inp,
                                                                               sequence_length=sequence_length,
                                                                               dtype=dtype,
                                                                               hparams=hparams,
    ...
    def _build_bidirectional_rnn(self, inputs, sequence_length,
        ...
        bi_outputs, bi_state = tf.nn.bidirectional_dynamic_rnn(fw_cell, bw_cell, inputs, dtype=dtype,
                                                               sequence_length=sequence_length,
                                                               time_major=self.time_major,
                                                               swap_memory=True)
    ...
    def _build_decoder_cell(self, hparams, encoder_outputs, encoder_state,
        ...
        if hparams.language_model:
            ...
            raise ValueError("For non-attentional model, pass_hidden_state needs to be set to True")
